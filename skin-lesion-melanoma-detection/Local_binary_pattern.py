# -*- coding: utf-8 -*-
"""
This code is adapted from the correction provided Mr Gavet and Mr Debayle of the practical about Local Binary Patterns.
"""
import numpy as np
...
plt.plot(h)
plt.show()
fig.savefig('non_melanomas.pdf', bbox_inches='tight')
